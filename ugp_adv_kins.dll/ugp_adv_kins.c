...
extern char asc_1000A57C[2]; // weak
...
signed int __cdecl sub_10001000(const void *a1, const void *a2, int a3, int a4, int a5, int a6, const void *a7, const void *a8, const void *a9)
{
  ...
  double v43[3]; // [sp+50h] [bp-210h]@1
  double v44[3]; // [sp+68h] [bp-1F8h]@1
  ...
  *(_QWORD *)&dbl_1000BBA0 = 0i64;
  ...
  if ( v36 )
  {
    v11("WARNING: Tool axis is parallelled with secondary axis that may cause unresolved rotaries");
    *(_QWORD *)&dbl_1000BF38 = 0i64;
  }
  else
  {
  ...
  do
  {
    v16 = v44[v15 / 8] * 1000000.0;
    v17 = &v44[v15 / 8];
    v15 += 8;
    *(double *)((char *)&v52 + v15) = v16 + *(double *)((char *)v17 + v14);
    v18 = *(double *)((char *)v17 + v14) - v16;
    v54[v15 / 8] = v18;
    v19 = *(double *)((char *)&v42 + v15) * 1000000.0;
    *(double *)((char *)&v57 + v15) = v19 + *(double *)(v15 + a5 - 8);
    v20 = *(double *)(v15 + a5 - 8) - v19;
    *(int *)((char *)&v64 + v15) = *(_DWORD *)((char *)&v52 + v15);
    v21 = *(_DWORD *)((char *)&v52 + v15 + 4);
    v41 = v20;
    v59[v15 / 8] = v20;
    *(int *)((char *)&v65 + v15) = v21;
    v22 = *(_DWORD *)((char *)&v57 + v15);
    v67[v15 / 8] = v18;
    v23 = v41;
    *(int *)((char *)&v60 + v15) = v22;
    *(int *)((char *)&v61 + v15) = *(_DWORD *)((char *)&v57 + v15 + 4);
    v63[v15 / 8] = v23;
  }
  ...
  else
  {
    ...
    do
    {
      v26 = v43[v25 / 8] * 1000000.0;
      v27 = &v43[v25 / 8];
      v25 += 8;
      *(double *)((char *)&v52 + v25) = v26 + *(double *)((char *)v27 + v24);
      v28 = *(double *)((char *)v27 + v24) - v26;
      v54[v25 / 8] = v28;
      v29 = *(double *)((char *)&v48 + v25) * 1000000.0;
      *(double *)((char *)&v57 + v25) = v29 + *(double *)((char *)a7 + v25 - 8);
      v30 = *(double *)((char *)a7 + v25 - 8) - v29;
      *(int *)((char *)&v64 + v25) = *(_DWORD *)((char *)&v52 + v25);
      v31 = *(_DWORD *)((char *)&v52 + v25 + 4);
      v41 = v30;
      v59[v25 / 8] = v30;
      *(int *)((char *)&v65 + v25) = v31;
      v32 = *(_DWORD *)((char *)&v57 + v25);
      v67[v25 / 8] = v28;
      v33 = v41;
      *(int *)((char *)&v60 + v25) = v32;
      *(int *)((char *)&v61 + v25) = *(_DWORD *)((char *)&v57 + v25 + 4);
      v63[v25 / 8] = v33;
    }
...
signed int __cdecl sub_10001F50(int a1, int a2)
{
  ...
  signed int v7; // edx@3
  int v8; // edi@4
  signed int v9; // [sp+Ch] [bp-CCh]@2
  char *v10; // [sp+10h] [bp-C8h]@1
  char *v11; // [sp+14h] [bp-C4h]@1
  char *v12; // [sp+18h] [bp-C0h]@1
  char *v13; // [sp+1Ch] [bp-BCh]@1
  char v14[32]; // [sp+20h] [bp-B8h]@2
  char v15; // [sp+40h] [bp-98h]@1
  char v16; // [sp+50h] [bp-88h]@1
  char v17; // [sp+58h] [bp-80h]@1
  char v18; // [sp+78h] [bp-60h]@1
  char v19; // [sp+98h] [bp-40h]@1
  char v20; // [sp+B8h] [bp-20h]@1

  memcpy(&v20, (const void *)(a1 + 96), 0x20u);
  memcpy(&v18, (const void *)(a1 + 64), 0x20u);
  memcpy(&v19, (const void *)(a1 + 32), 0x20u);
  memcpy(&v17, (const void *)a1, 0x20u);
  v10 = &v17;
  v11 = &v19;
  v12 = &v18;
  v13 = &v20;
  result = sub_10004230((int)&v10, 4, (int)&v15, (int)&v16);
  if ( !result )
  {
    v3 = a2;
    v4 = &v14[-a2];
    ...
    do
    {
      ...
      *(_DWORD *)&v4[v3] = 0;
      *(_DWORD *)&v4[v3 + 4] = 1072693248;
      sub_10004510((int)&v10, 4, (int)&v15, (int)v14);
      v5 = (int)v14;
      v6 = v3;
      v7 = 4;
      do
...
signed int __cdecl sub_10002590(const void *a1, int a2, void *a3)
{
  ...
  long double v15; // st6@26
  long double v16; // st7@26
  ...
  __int16 v39; // fps@95
  char v40; // c0@95
  char v41; // [sp+2Fh] [bp-D9h]@1
  double v42; // [sp+30h] [bp-D8h]@21
  double v43; // [sp+30h] [bp-D8h]@32
  double v44; // [sp+30h] [bp-D8h]@45
  double v45; // [sp+30h] [bp-D8h]@57
  double v46; // [sp+38h] [bp-D0h]@12
  double v47; // [sp+40h] [bp-C8h]@12
  double v48; // [sp+48h] [bp-C0h]@16
  double v49; // [sp+50h] [bp-B8h]@16
  double v50; // [sp+58h] [bp-B0h]@22
  long double v51; // [sp+60h] [bp-A8h]@10
  double v52; // [sp+68h] [bp-A0h]@21
  double v53; // [sp+70h] [bp-98h]@79
  long double v54; // [sp+80h] [bp-88h]@10
  int v55[2]; // [sp+88h] [bp-80h]@10
  double v56; // [sp+90h] [bp-78h]@10
  long double v57; // [sp+98h] [bp-70h]@10
  double v58; // [sp+A0h] [bp-68h]@26
  double v59; // [sp+A8h] [bp-60h]@79
  int v60; // [sp+BCh] [bp-4Ch]@1
  double v61; // [sp+C0h] [bp-48h]@10
  double v62; // [sp+C8h] [bp-40h]@10
  int v63; // [sp+D4h] [bp-34h]@8
  int v64; // [sp+D8h] [bp-30h]@6
  char v65; // [sp+F0h] [bp-18h]@6
  ...
  if ( dword_1000BC00 == 3 )
  {
    UF_MTX3_vec_multiply_t(a1, &unk_100091A0, &v64);
    UF_MTX3_vec_multiply_t((char *)a1 + 24, &unk_100091A0, &v65);
  }
  else
  {
    memcpy(&v64, a1, 0x30u);
  ...
  UF_VEC3_is_zero(&v65, LODWORD(dbl_1000A010), HIDWORD(dbl_1000A010), &v63);
  if ( v63 )
    return 4;
  UF_VEC3_unitize(&v65, LODWORD(dbl_1000A010), HIDWORD(dbl_1000A010), &v62, v55);
  *(_QWORD *)&v54 = *(_QWORD *)v55;
  ...
  if ( *(_DWORD *)dword_1000BEF0 != 3 )
  {
    v50 = dbl_1000BD30 * v57 + dbl_1000BD10 * v56 + dbl_1000BCF0 * *(double *)v55;
    v43 = dbl_1000BD38 * v57 + dbl_1000BD18 * v56 + dbl_1000BCF8 * *(double *)v55;
    if ( fabs(dbl_1000BBE0) > dbl_1000A010 )
    {
      ...
      v58 = (v20
           - (dbl_1000BD40 * v57
            + dbl_1000BD20 * v56
            + dbl_1000BD00 * *(double *)v55
            - (dbl_1000BD48 * v57 + dbl_1000BD28 * v56 + dbl_1000BD08 * *(double *)v55) * dbl_1000BF18)
           * dbl_1000BEF8)
          / dbl_1000BBE0;
    }
    else
    ...
    v52 = sqrt(v43 * v43 + v50 * v50);
    if ( fabs(v50) > dbl_1000A010 || fabs(v43) > dbl_1000A010 )
      v21 = atan2(v50, v43);
    else
      v21 = 0.0;
    if ( fabs(v52) > dbl_1000A010 )
      v44 = v58 / v52;
    else
      v44 = 0.0;
    if ( dbl_1000A010 + 1.0 >= fabs(v44) )
    {
      v22 = 1.0 - v44 * v44;
      if ( fabs(v22) <= dbl_1000A010 )
        v22 = 0.0;
      if ( fabs(v44 - 1.0) > dbl_1000A010 )
        v23 = sqrt(v22);
      else
        v23 = 0.0;
      v46 = atan2(v23, v44) + v21;
      v47 = atan2(-v23, v44) + v21;
    }
    else
    {
      printf(
    ...
    do
    {
      v26 = *(double *)((char *)&v46 + v24);
      v50 = sin(v26);
      v27 = cos(v26);
      if ( v25 > dbl_1000A010 )
      {
        v58 = v27 * dbl_1000BEF8;
        v52 = -(dbl_1000BBE0 * dbl_1000BF18);
        v28 = ((v50 * dbl_1000BD38 + v27 * dbl_1000BD30 - dbl_1000BF10 * dbl_1000BD48) * v51
             + (v50 * dbl_1000BD18 + v27 * dbl_1000BD10 - dbl_1000BF10 * dbl_1000BD28) * v61
             + (v50 * dbl_1000BCF8 + v27 * dbl_1000BCF0 - dbl_1000BF10 * dbl_1000BD08) * v54)
            / dbl_1000BBD8;
        v45 = -(((dbl_1000BBE0 * dbl_1000BD40
                + v58 * dbl_1000BD38
                + -(v50 * dbl_1000BEF8) * dbl_1000BD30
                + v52 * dbl_1000BD48)
               * v51
               + (dbl_1000BBE0 * dbl_1000BD20
                + v58 * dbl_1000BD18
                + -(v50 * dbl_1000BEF8) * dbl_1000BD10
                + v52 * dbl_1000BD28)
               * v61
               + (dbl_1000BBE0 * dbl_1000BD00
                + v58 * dbl_1000BCF8
                + -(v50 * dbl_1000BEF8) * dbl_1000BCF0
                + v52 * dbl_1000BD08)
               * v54)
              / dbl_1000BBD8);
      }
      ...
      if ( fabs(v28) > dbl_1000A010 || fabs(v45) > dbl_1000A010 )
      {
        *(double *)((char *)&v48 + v24) = atan2(v45, v28);
      }
      else
      {
        *(_DWORD *)((char *)&v48 + v24) = 0;
        *(_DWORD *)((char *)&v48 + v24 + 4) = 0;
        v41 = 1;
      }
      v24 += 8;
    }
  ...
  if ( dword_1000BC00 )
  {
    if ( dword_1000BC00 != 1 && dword_1000BC00 != 3 )
      return 2;
    *(_QWORD *)&v42 = qword_1000BED8;
    v52 = dbl_1000BEE8;
    *(_QWORD *)&v51 = qword_1000BEE0;
    if ( fabs(dbl_1000BEE8 - 1.0) <= dbl_1000A010
      || (v50 = (v57 - dbl_1000BEE8 * dbl_1000BEE8) / (1.0 - dbl_1000BEE8 * dbl_1000BEE8),
          v12 = fabs(v50),
          dbl_1000A010 + 1.0 < v12) )
    {
      *(_QWORD *)&v46 = qword_1000BE08;
      v41 = 1;
      *(_QWORD *)&v47 = qword_1000BE10;
    }
    else
    {
      sub_100035B0(v50);
    ...
    do
    {
      ...
      v58 = v17 * v61 + v50 * v54;
      v18 = v50 * v61 - v17 * v54;
      if ( fabs(v18) > dbl_1000A010 || fabs(v58) > dbl_1000A010 )
      {
        *(double *)((char *)&v48 + v13 * 8) = atan2(v58, v18);
      }
      else
      {
        v19 = HIDWORD(qword_1000BDF8[v13]);
        *(_DWORD *)((char *)&v48 + v13 * 8) = LODWORD(qword_1000BDF8[v13]);
        *(_DWORD *)((char *)&v48 + v13 * 8 + 4) = v19;
        v41 = 1;
      }
      ++v13;
    }
...
LABEL_64:
  ...
  v46 = asin(-v56);
  v10 = sqrt(v57 * v57 + *(double *)v55 * *(double *)v55);
  sub_100035B0(v10);
  v47 = v10;
  if ( fabs(v46 - v10) <= dbl_1000A010 )
  {
    v11 = -sqrt(v51 * v51 + v54 * v54);
    sub_100035B0(v11);
    v47 = v11;
  }
  if ( fabs(v54) <= dbl_1000A010 && fabs(v51) <= dbl_1000A010 )
  {
    *(_QWORD *)&v48 = qword_1000BDF8[0];
    *(_QWORD *)&v49 = qword_1000BE00;
    v41 = 1;
LABEL_65:
    if ( *(_DWORD *)dword_1000BEF0 != 3 )
    {
...
LABEL_68:
  ...
  else
  {
      ...
      if ( v29 == 2 || v29 == 3 )
      {
        if ( byte_1000BF40 )
        {
          ...
          printf(
            ...
            (dbl_1000BBB0 + dbl_1000BBB0 - v46) * 57.29577951308235,
            (dbl_1000BBA0 + dbl_1000BBA0 - v48) * 57.29577951308235);
          printf(
            "computing t1[1]=%f, t2[1]=%f, (Init_T1[1]*2-t1[1])=%f,(Init_T2[1]*2-t2[1])=%f\n",
            v47 * 57.29577951308235,
            v49 * 57.29577951308235,
            (dbl_1000BBB8 + dbl_1000BBB8 - v47) * 57.29577951308235,
            (dbl_1000BBA8 + dbl_1000BBA8 - v49) * 57.29577951308235);
        }
        sub_10003CD0((int)&v46, (int)&v48);
        if ( *(_DWORD *)dword_1000BEF0 == 2 )
        {
          ...
          v52 = v48;
          v53 = v49;
          sub_10003990(v55, (int)&v58, (int)&v52);
          v49 = v53;
          v47 = v59;
          v46 = v58;
          v48 = v52;
          sub_10003600(&v64, v58, v52, (void *)a2, 1);
          sub_10003600(&v64, v59, v53, (void *)v3, 1);
        }
        else
        {
          sub_10003820((int)&v64, -v48, a2);
          sub_10003820((int)&v64, -v49, v3);
          if ( dword_1000BC00 == 3 )
          {
            v30 = 0;
            do
    ...
    if ( *(_DWORD *)dword_1000BEF0 == 1 )
    {
      v33 = *(double *)(dword_1000BEF0 + 144) + *(double *)(dword_1000BEF0 + 136);
      v52 = v33;
      v34 = HIDWORD(v52);
      UF_VEC3_affine_comb(a2, LODWORD(v33), *(unsigned __int64 *)&v33 >> 32, v55, a2);
      UF_VEC3_affine_comb(v3, LODWORD(v52), v34, v55, v3);
      sub_100037A0(a2, v46, 0, 0, a2);
      sub_100037A0(v3, v47, 0, 0, v3);
    }
    else
    {
      if ( v32 == 3 )
      {
        sub_10003820((int)v55, -v48, (int)&v52);
        UF_VEC3_unitize(&v52, LODWORD(dbl_1000A010), HIDWORD(dbl_1000A010), &v62, &v52);
        UF_VEC3_affine_comb(a2, *(_DWORD *)(dword_1000BEF0 + 136), *(_DWORD *)(dword_1000BEF0 + 140), &v52, a2);
        UF_VEC3_affine_comb(v3, *(_DWORD *)(dword_1000BEF0 + 136), *(_DWORD *)(dword_1000BEF0 + 140), &v52, v3);
      }
      else
      {
        if ( v32 == 2 )
        {
          sub_10003600(v55, v46, v48, &v52, 0);
          sub_10003600(v55, v47, v49, &v58, 0);
          UF_VEC3_unitize(&v52, LODWORD(dbl_1000A010), HIDWORD(dbl_1000A010), &v62, &v52);
          UF_VEC3_unitize(&v58, LODWORD(dbl_1000A010), HIDWORD(dbl_1000A010), &v62, &v58);
          UF_VEC3_affine_comb(a2, *(_DWORD *)(dword_1000BEF0 + 136), *(_DWORD *)(dword_1000BEF0 + 140), &v52, a2);
          UF_VEC3_affine_comb(v3, *(_DWORD *)(dword_1000BEF0 + 136), *(_DWORD *)(dword_1000BEF0 + 140), &v58, v3);
        }
      }
    }
    *(double *)(a2 + 24) = v46 * 57.29577951308235;
    *(double *)(v3 + 24) = v47 * 57.29577951308235;
    *(double *)(a2 + 32) = v48 * 57.29577951308235;
    *(double *)(v3 + 32) = v49 * 57.29577951308235;
    if ( byte_1000A018 && *(_DWORD *)dword_1000BEF0 != 3 )
    {
      v35 = *(double *)(a2 + 32) - 90.0;
      UNDEF(v36);
      *(_QWORD *)(a2 + 32) = *(_QWORD *)&v35;
      if ( v37 )
        *(double *)(a2 + 32) = v35 + 360.0;
      v38 = *(double *)(v3 + 32) - 90.0;
      UNDEF(v39);
      *(_QWORD *)(v3 + 32) = *(_QWORD *)&v38;
      if ( v40 )
        *(double *)(v3 + 32) = v38 + 360.0;
    }
    if ( v41 && *(_DWORD *)dword_1000BEF0 != 3 )
    {
    ...
    if ( byte_1000BF40 && fabs(v46 - v47) <= dbl_1000A010 )
    {
      if ( fabs(v48 - v49) <= dbl_1000A010 )
        printf("WARNING: same value of rotary produced:\n");
    }
    memcpy(&unk_1000BC20, (const void *)a2, 0x28u);
    memcpy(&unk_1000BEB0, a3, 0x28u);
    qword_1000BE08 = *(_QWORD *)&v46;
    qword_1000BDF8[0] = *(_QWORD *)&v48;
    qword_1000BE10 = *(_QWORD *)&v47;
    result = v60;
    qword_1000BE00 = *(_QWORD *)&v49;
  }
  return result;
}
...
int __cdecl sub_10003870(long double a1, int a2, int a3)
{
  ...
  *(long double *)(a3 + 8) = *(double *)(v4 + 8) * *(double *)v4 * (1.0 - v3) + v6 * *(double *)(v4 + 16);
  v9 = *(double *)(v4 + 16) * *(double *)v4 * (1.0 - v3);
  v10 = v6 * *(double *)(a2 + 8);
  *(_DWORD *)(a3 + 24) = 0;
  *(_DWORD *)(a3 + 28) = 0;
  *(long double *)(a3 + 16) = v9 - v10;
  *(long double *)(a3 + 32) = *(double *)(v4 + 8) * *(double *)v4 * (1.0 - v3) - v6 * *(double *)(v4 + 16);
  *(long double *)(a3 + 40) = (1.0 - v7) * v3 + v7;
  v11 = *(double *)(v4 + 16) * *(double *)(v4 + 8) * (1.0 - v3);
  v12 = v6 * *(double *)a2;
  *(_DWORD *)(a3 + 56) = 0;
  *(_DWORD *)(a3 + 60) = 0;
  *(long double *)(a3 + 48) = v11 + v12;
  *(long double *)(a3 + 64) = *(double *)(v4 + 16) * *(double *)v4 * (1.0 - v3) + v6 * *(double *)(a2 + 8);
  *(long double *)(a3 + 72) = *(double *)(v4 + 16) * *(double *)(v4 + 8) * (1.0 - v3) - v6 * *(double *)a2;
  *(_DWORD *)(a3 + 88) = 0;
  *(_DWORD *)(a3 + 96) = 0;
  *(_DWORD *)(a3 + 104) = 0;
  *(_DWORD *)(a3 + 112) = 0;
...
int __cdecl sub_10003990(const void *a1, int a2, int a3)
{
  ...
  int result; // eax@11
  int v18; // edx@11
  signed int v19; // [sp+10h] [bp-E8h]@3
  signed int v20; // [sp+10h] [bp-E8h]@7
  double v21; // [sp+18h] [bp-E0h]@1
  double v22; // [sp+20h] [bp-D8h]@1
  double v23; // [sp+28h] [bp-D0h]@1
  int v24; // [sp+30h] [bp-C8h]@1
  int v25; // [sp+34h] [bp-C4h]@1
  int v26; // [sp+38h] [bp-C0h]@1
  int v27; // [sp+3Ch] [bp-BCh]@1
  int v28; // [sp+40h] [bp-B8h]@1
  int v29; // [sp+44h] [bp-B4h]@1
  int v30; // [sp+48h] [bp-B0h]@4
  char v31; // [sp+60h] [bp-98h]@4
  int Base; // [sp+68h] [bp-90h]@3
  int v33; // [sp+6Ch] [bp-8Ch]@7
  double v34; // [sp+98h] [bp-60h]@1
  double v35; // [sp+A0h] [bp-58h]@1
  double v36; // [sp+A8h] [bp-50h]@1
  double v37; // [sp+B0h] [bp-48h]@1
  double v38; // [sp+B8h] [bp-40h]@1
  double v39; // [sp+C0h] [bp-38h]@1
  double v40; // [sp+C8h] [bp-30h]@1
  double v41; // [sp+D0h] [bp-28h]@1
  double v42; // [sp+D8h] [bp-20h]@1
  double v43; // [sp+E0h] [bp-18h]@1
  double v44; // [sp+E8h] [bp-10h]@1
  double v45; // [sp+F0h] [bp-8h]@1

  v3 = *(_DWORD *)(a2 + 8);
  v4 = *(_DWORD *)(a2 + 12);
  v40 = *(double *)a2;
  *(_QWORD *)&v5 = __PAIR__(v4, v3);
  v24 = 0;
  v25 = 0;
  v26 = 0;
  v21 = v40 * -1.0;
  ...
  v44 = 3.141592653589793 - v40 * -1.0;
  v45 = v40 * -1.0 + 3.141592653589793;
  v35 = v5 * -1.0;
  v36 = v5 + 3.141592653589793;
  v37 = 3.141592653589793 - v5;
  v38 = 3.141592653589793 - v5 * -1.0;
  v39 = v5 * -1.0 + 3.141592653589793;
  ...
  *(_DWORD *)(a2 + 4) = v12;
  ...
  do
  {
    sub_10003600(a1, *(double *)v15, v22, &v30, 0);
    UF_VEC3_unitize(&v30, LODWORD(dbl_1000A010), HIDWORD(dbl_1000A010), &v31, &v30);
    UF_VEC3_is_equal(&v24, &v30, LODWORD(dbl_1000A010), HIDWORD(dbl_1000A010), &v21);
    if ( LODWORD(v21) )
    {
...
void __cdecl sub_10003CD0(int a1, int a2)
{
  ...
  if ( fabs(*(double *)a1 - *(double *)(a1 + 8)) <= dbl_1000A010
    ...
    && fabs(*(double *)a1 - *(double *)a2) > dbl_1000A010 )
  {
    v5 = -dbl_1000A010;
    if ( *(double *)a1 >= v5 )
    {
  ...
  v3 = *(double *)a1;
  if ( fabs(v3 - *(double *)a2) <= dbl_1000A010 && fabs(*(double *)(a1 + 8) - *(double *)(a2 + 8)) <= dbl_1000A010 )
  {
    if ( -dbl_1000A010 <= *(double *)(a2 + 8) )
    {
      if ( dbl_1000A010 >= *(double *)(a2 + 8) )
        ...
        *(_QWORD *)a6 = *(_QWORD *)&v12;
        do
        {
          ...
          *(double *)(a3 - a1 + v10 - 8) = v13 + *(double *)(v10 - 8);
          v14 = *(double *)(&v23[v10 - 8] - a1) * *(double *)a6 + *(double *)(LODWORD(v17) + v10 - 8);
          v15 = LODWORD(v16)-- == 1;
          *(_QWORD *)(a4 - a1 + v10 - 8) = *(_QWORD *)&v14;
        }
        while ( !v15 );
        return 0;
      }
      ...
      *(_DWORD *)(v4 + 8 * v11 + 4) = *(_DWORD *)(v4 + 8 * v7 + 4);
      if ( v24 )
      {
        if ( v8 < v7 )
        {
          ...
          do
          {
            v15 = *(double *)(*(_DWORD *)v10 - v4 + v13) * *(double *)v13;
            v13 += 8;
            --v14;
            v12 = v12 - v15;
          }
  ...
  if ( v6 - 1 >= 0 )
  {
    ...
    do
    {
      ...
      if ( v17 < v6 )
      {
        ...
        do
        {
          v22 = *(double *)(v20 + *(_DWORD *)v18 - v4) * *(double *)v20;
          v20 += 8;
          --v21;
          v19 = v19 - v22;
        }
...
int __cdecl sub_10007130(int a1, int a2)
{
  ...
  int v13[5]; // [sp+44h] [bp-44h]@2
  int v14; // [sp+58h] [bp-30h]@2
  int v15[5]; // [sp+5Ch] [bp-2Ch]@2
  int v16; // [sp+70h] [bp-18h]@2
  int v17[5]; // [sp+74h] [bp-14h]@2
...
int __cdecl sub_100072C0(int a1, int a2, int a3)
{
  ...
  int *v11; // ecx@13
  int v12; // eax@13
  signed int v13; // esi@13
  int v14; // edi@14
  char *v16; // [sp-18h] [bp-178h]@5
  double v17; // [sp-14h] [bp-174h]@5
  char *v18; // [sp-Ch] [bp-16Ch]@5
  int v19; // [sp+18h] [bp-148h]@1
  signed int v20; // [sp+1Ch] [bp-144h]@1
  double v21; // [sp+20h] [bp-140h]@1
  int v22; // [sp+28h] [bp-138h]@1
  int v23; // [sp+2Ch] [bp-134h]@1
  int v24; // [sp+30h] [bp-130h]@1
  int v25; // [sp+34h] [bp-12Ch]@1
  int v26; // [sp+38h] [bp-128h]@1
  int v27; // [sp+3Ch] [bp-124h]@1
  int v28; // [sp+40h] [bp-120h]@1
  int v29; // [sp+44h] [bp-11Ch]@1
  int v30; // [sp+48h] [bp-118h]@1
  int v31; // [sp+4Ch] [bp-114h]@1
  int v32; // [sp+50h] [bp-110h]@1
  int v33; // [sp+54h] [bp-10Ch]@1
  int v34; // [sp+58h] [bp-108h]@1
  int v35; // [sp+5Ch] [bp-104h]@1
  int v36; // [sp+60h] [bp-100h]@1
  int v37; // [sp+64h] [bp-FCh]@1
  int v38; // [sp+68h] [bp-F8h]@1
  int v39; // [sp+6Ch] [bp-F4h]@1
  char v40; // [sp+70h] [bp-F0h]@5
  char v41; // [sp+88h] [bp-D8h]@1
  ...
  v4 = a3 + 8;
  v20 = 3;
  v21 = asin(1.0) * 0.01111111111111111;
  do
  {
    if ( (unsigned int)(signed __int64)*(double *)(v4 - 8) == 1 )
    {
      v7 = v21 * *(double *)v4 * -1.0;
      UF_MTX3_x_vec(&v22, &v40);
      v18 = v3;
      v17 = v7;
      v16 = &v40;
    }
    else
    {
      ...
      {
        v6 = v21 * *(double *)v4 * -1.0;
        UF_MTX3_y_vec(&v22, &v40);
        v18 = v3;
        v17 = v6;
        v16 = &v40;
      }
      else
      {
        if ( (unsigned int)(signed __int64)*(double *)(v4 - 8) != 3 )
          goto LABEL_9;
        v5 = v21 * *(double *)v4 * -1.0;
        UF_MTX3_z_vec(&v22, &v40);
        v18 = v3;
        v17 = v5;
        v16 = &v40;
      }
    }
    UF_MTX3_rotate_about_axis(v16, LODWORD(v17), HIDWORD(v17), v18);
    v3 += 72;
    ++v19;
LABEL_9:
    v4 += 16;
  ...
  do
  {
    ...
    *(_DWORD *)v12 = *(v11 - 2);
    *(_DWORD *)(v12 + 4) = *(v11 - 1);
    *(_DWORD *)(v12 + 24) = *(_DWORD *)&v10[v12];
    *(_DWORD *)(v12 + 28) = *(_DWORD *)&v10[v12 + 4];
    v12 += 8;
    --v13;
  }
  while ( v13 );
...
signed int __cdecl sub_100078F0(int a1, int a2, signed int a3, int a4)
{
  ...
  unsigned int v22; // [sp+4Ch] [bp+Ch]@6
...
signed int __cdecl sub_10007C40(int a1)
{
  ...
  int Memory; // [sp+10h] [bp-360h]@1
  void *v26; // [sp+14h] [bp-35Ch]@1
  void *Str; // [sp+18h] [bp-358h]@1
  ...
  double v33[3]; // [sp+30h] [bp-340h]@12
  ...
  double v59[3]; // [sp+128h] [bp-248h]@3
  double v60[3]; // [sp+140h] [bp-230h]@5
  double v61[3]; // [sp+158h] [bp-218h]@5
  double v62[3]; // [sp+170h] [bp-200h]@5
  ...
  Memory = (int)malloc(0x358u);
  sub_10004810(a1, Memory);
  v26 = malloc(0x228u);
  ...
  *((_DWORD *)v2 + 8) = v28;
  ...
  sub_10006A00(a1, (char *)v59);
  v4 = v1 + 432;
  v5 = Memory + 832;
  v6 = 0;
  do
  {
    v7 = v59[v6] + *(double *)(v24 - v1 + v4);
    ++v6;
    v4 += 8;
    v5 += 8;
    *(_QWORD *)((char *)&v55 + v6 * 8) = *(_QWORD *)&v7;
    *(double *)((char *)&v57 + v6 * 8) = v7 + *(double *)(v4 - 8);
    *(double *)((char *)&v53 + v6 * 8) = v7 + *(double *)(v5 - 8);
  }
  while ( v6 < 3 );
  ...
  else
  {
    ...
    {
      if ( !strstr((const char *)Str, "POSZ") )
      {
        if ( strstr((const char *)Str, "NEGX") )
        {
          v11 = 0;
          do
          {
  ...
  v8 = strstr;
LABEL_24:
  if ( v8((const char *)Memory, "5_axis_dual_table") )
  {
    v34 = 2;
  }
  else
  {
    if ( v8((const char *)Memory, "5_axis_dual_head") )
    {
      v34 = 1;
    }
    else
    {
      if ( v8((const char *)Memory, "5_axis_head_table") )
        v34 = 3;
    }
  }
  v14 = *(_DWORD *)(Memory + 800);
  v36 = *(_DWORD *)(Memory + 804);
  v35 = v14;
  memcpy(&v37, &v67, 0x18u);
  memcpy(&v38, &v68, 0x18u);
  memcpy(&v39, (const void *)(v24 + 432), 0x18u);
  v15 = atoi((const char *)(Memory + 133)) == 1;
  v41 = v71;
  v42 = v72;
  v16 = *((_DWORD *)v2 + 4);
  v40 = v15;
  ...
  v51 = v69;
  v52 = v70;
  if ( strstr((const char *)Memory, "5_axis_dual_table") )
  {
    v53 = 0.0;
  }
  else
...
// 10007C40: using guessed type double var_248[3];
